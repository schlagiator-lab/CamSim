...
export default function UploadZone({ onImageLoad }: Props) {
  ...
  return (
    <div
      ...
      style={{
        border: `2px dashed ${dragging ? '#bf393a' : '#2a2a3a'}`,
        borderRadius: 12,
        background: dragging ? 'rgba(191,57,58,0.04)' : 'transparent',
    ...
    >
      <svg width={56} height={56} viewBox="0 0 56 56" fill="none" style={{ marginBottom: 16 }}>
        ...
        <path d="M28 18v14M21 25l7-7 7 7" stroke="#bf393a" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" />
        <path d="M18 36h20" stroke="#2a2a3a" strokeWidth={2} strokeLinecap="round" />
      </svg>
      <p style={{ fontFamily: 'Orbitron', color: '#bf393a', fontSize: 13, letterSpacing: 2, marginBottom: 8 }}>
        CHARGER UNE PHOTO
      </p>
